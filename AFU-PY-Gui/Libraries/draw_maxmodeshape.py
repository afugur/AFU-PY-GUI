...
def modeshapeSensorDrawing(self,X_df,Y_df,length,width,height,z_dim,mod):
    ...
    # outside surface
    self.ax.clear()
    self.ax.plot_wireframe(x1, y11, z1, color='gray',alpha=0.7) # front
    # inside surface
    self.ax.plot_wireframe(x1, y12, z1, color='gray',alpha=0.7) # behind
    
    self.ax.plot_wireframe(x2, y2, z21, color='grey',alpha=0.7) # below
    # bottom surface
    self.ax.plot_wireframe(x2, y2, z22, color='grey',alpha=0.7) # top
    # left surface
    self.ax.plot_wireframe(x31, y3, z3, color='gray',alpha=0.7) # left
    # right surface
    self.ax.plot_wireframe(x32, y3, z3, color='gray',alpha=0.7) # right
    ...
    self.ax.plot_wireframe(x1, y11, z1, color='red') # front
    # inside surface
    self.ax.plot_wireframe(x1, y12, z1, color='red') # behind
    ...
    self.ax.plot_wireframe(x31, y3, z3, color='red') # left
    # right surface
    self.ax.plot_wireframe(x32, y3, z3, color='red') # right
    ...
    self.ax.plot_wireframe(x2, y2, z21, color='red') # below
    ...
    self.ax.plot_wireframe(x2, y2, z22, color='red') # top
    ...
    self.chart_type4.draw()
    

# modeshapeSensorDrawing(X_max_df,Y_max_df,50,18,22.5,10,5)